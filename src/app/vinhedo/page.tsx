...
export const metadata = {
  title: "Telhas Metálicas em Vinhedo | Nossa Calhas & Telhas",
  description:
    "Fabricação e instalação de telhas metálicas, telhas termoacústicas, calhas e rufos em Vinhedo .",
};
    ...
    <main>
      ...
      <section className="bg-blue-700 py-24 text-white">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h1 className="text-5xl font-black">
            Telhas Metálicas em Vinhedo 
          </h1>

          <p className="mt-6 max-w-3xl text-xl text-blue-100">
            Atendemos Vinhedo  com fabricação própria de telhas metálicas,
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <h2 className="text-3xl font-black">
          Atendimento em toda Vinhedo 
        </h2>

        <p className="mt-6 leading-8 text-slate-600">
          Nossa Calhas & Telhas fabrica produtos sob medida para
          residências, galpões, comércios e indústrias em Vinhedo ,
